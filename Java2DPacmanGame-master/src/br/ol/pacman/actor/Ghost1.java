 ...
 */
public class Ghost1 extends PacmanActor {
    ...
    public Ghost1(PacmanGame game, Pacman pacman, int type) {
        super(game);
        this.pacman = pacman;
        this.type = type;
...
//        }
    ...
    private class GhostCatchedAction implements Runnable {
        ...
        @Override
        public void run() {
            game.ghostCatched1(Ghost1.this);
        }
    }
    ...
    private void updateGhostMovement(Runnable collisionWithPacmanAction/*boolean useTarget, int targetCol, int targetRow
       ...
       if ("Ghost1Esquerda".equals(me)) {
            desiredDirection = 2;
        } else if ("Ghost1Direita".equals(me2)) {
            desiredDirection = 0;
        } else if ("Ghost1Acima".equals(me3)) {
            desiredDirection = 3;
        } else if ("Ghost1Abaixo".equals(me4)) {
            desiredDirection = 1;
        }
